...
namespace BumbleBee.Utility
{
	public class PayPalService
	{
		...
		public async Task SendInvoiceEmailAsync(string paymentId, string recipientEmail)
		{
			...
			{
				smtpClient.Connect(_configuration["Smtp:Host"], int.Parse(_configuration["Smtp:Port"]), SecureSocketOptions.StartTls);
				smtpClient.Authenticate(_configuration["Smtp:Email"], _configuration["Smtp:Password"]);
